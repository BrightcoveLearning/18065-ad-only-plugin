...
# 18065-ad-only-plugin
For more information about this sample see: https://support.brightcove.com/ad-only-plugin.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>ad-only.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>ad-only.css</strong>.</td>
    </tr>
  </tbody>
</table>
